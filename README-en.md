...
* **Debug Log Symlink:** Optional creation of a debug.log symlink in the root directory, pointing to wp-content/debug.log.
* **Debug Log Viewer (PHP):** Optional creation of a **debug-viewer.php** script in the root directory. This script displays the content of debug.log in the browser (as plain text) **without** loading WordPress. Ideal for quick error analysis, even during Fatal Errors that crash the main site.
